...
This project is a solution to the "Results Summary Component" challenge found on [Frontend Mentor](https://www.frontendmentor.io/challenges/results-summary-component-CE_K6s0maV). The challenge involves creating a summary component for displaying various statistics in a visually appealing manner.
...
1. Clone this repository to your local machine using the following command:
   ...
   ```
   git clone https://github.com/OmPreetham/results-summary-component.git
   ```
